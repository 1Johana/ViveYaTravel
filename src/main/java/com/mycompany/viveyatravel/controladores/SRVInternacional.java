...
public class SRVInternacional extends HttpServlet {
PaqueteDAO paqdao = new PaqueteDAO();
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (accion != null) {
            ...
            List<Paquete> internacional = paqdao.listInt(filtroNombre, filtroPrecio, filtroOrden); 
            ...
            request.setAttribute("internacional", internacional);
            request.getRequestDispatcher("./vista/internacionales.jsp").forward(request, response);
        }
    }
