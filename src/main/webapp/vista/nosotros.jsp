...
<section class="bg-light py-5">
    <div class="container text-center">
        <h2 class="text-primary fw-bold mb-5">NUESTROS CLIENTES...</h2>
        ...
        <div class="row g-4">
            <div class="col-md-6">
                <div class="ratio ratio-16x9 shadow rounded-4">
                    <iframe width="921" height="390" src="https://www.youtube.com/embed/mZgDvY6ENkM" title="TOUR FULL DAY PARACAS ICA - HUACACHINA" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>
            </div>
            <div class="col-md-6">
                <div class="ratio ratio-16x9 shadow rounded-4">
                    <iframe width="921" height="390" src="https://www.youtube.com/embed/7biaualce90" title="Tour Full Day Playa Tuquillo" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </section>
